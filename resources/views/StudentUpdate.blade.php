...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-6">
      ...
      <form action="{{route('student.update',$stu->id)}}" method="post" class="p-4 border rounded shadow-sm bg-light">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="city" id="city" class="form-control" value="{{$stu->city}}">
        </div>
